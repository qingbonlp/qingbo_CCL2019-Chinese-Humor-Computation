...
def main():
    ...
    parser.add_argument('--train_corpus', type=Path, default=r'cclhumortask12_bert.txt')
    parser.add_argument("--output_dir", type=Path, default='pytorchmodeltask12_wwm_1005')
    parser.add_argument("--bert_model", type=str, default=r'/home/jovyan/work/data/chinese_wwm_torch/')
